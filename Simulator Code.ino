...
void straight(float x_dest, float y_dest){
  ...
  //Enes100.println("Desired Theta: " + std::to_string(desired_tht));
  //Enes100.println("Y Destination" + std::to_string(y_dest));
...
void go2mission(){
  ...
  float tht = Enes100.location.theta;
  //Enes100.println("Y val:" + std::to_string(y));
  //Go to mission
  ...
  //Enes100.print("Mission Y:" + std::to_string(missionY));
  ...
  while(x < obs1X){
    ...
    while(USDist > distTol){
      ...
      if(USDist < distTol){
        ...
        //Enes100.println(obsCoord[0]);
        //Enes100.println(obsCoord[1]);
      }
    }
    stopMotors();
    Enes100.updateLocation();
    ...
    tht = Enes100.location.theta;
    if(x < obs1X){
      //Enes100.println("Going down an obstacle height to " + (y-obsHeight) +  "from" + y);
      float y1 = y;
